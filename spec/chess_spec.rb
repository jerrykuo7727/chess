...
describe Chess do
      ...
      it 'returns true if the position is checked' do
        ...
        chess.instance_variable_set(:@board, 
                [['.', '.', '.', '.', '.', '♚', '.', '.'],
                 ...
                 ['.', '.', '.', '.', '.', '.', '.', '.'],
                 ['.', '.', '.', '.', '.', '.', '.', '.']])
        expect(chess.check?([1,4])).to eql(true)
      end
    end
  end
  ...
  describe 'checkmate?' do
    it 'returns true if king is checkmated' do
      chess.instance_variable_set(:@turn, 'Black')
      chess.instance_variable_set(:@last_move, [3,4])
      chess.instance_variable_set(:@board, 
              [['.', '.', '.', '.', '.', '♚', '.', '♗'],
               ['.', '.', '.', '.', '.', '.', '.', '.'],
               ['.', '♘', '.', '.', '.', '.', '.', '♘'],
      ...
      chess.instance_variable_set(:@last_move, [2,3])
      chess.instance_variable_set(:@checked, true)
      chess.instance_variable_set(:@board, 
              [['♜', '♞', '♝', '♛', '♚', '♜', '.', '.'],
               ['♟', '♟', '.', '♟', '.', '♟', '♟', '♟'],
               ['.', '.', '.', '♘', '♟', '♗', '.', '.'],
